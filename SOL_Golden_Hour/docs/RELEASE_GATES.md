...
| P1 | Accessibility / real-device review | Sample contrast, semantic, keyboard and narrow-width checks completed. Full screen-reader, 200% text zoom, actual iOS/Android, browser file-save completion and caption review remain open. | Accessibility reviewer / owner |
